...
write.table(estimatedA,'./stage2/AdjMat0_1-80',row.names=F,col.names=F,quote=F,sep=" ")
write.table(estimatedC,'./stage2/CoeffMat0_1-80',row.names=F,col.names=F,quote=F,sep=" ")
